...
public class Test {
	public static void main(String[] args) throws DsgException {	
		...
		DeleteScriptsGeneratorFactory cleanupFactory = new DeleteScriptsGeneratorFactory();
		IDeleteScriptsGenerator cleanupScriptGenerator = cleanupFactory.createDatabaseAdapter(DatabaseType.ORACLE);
